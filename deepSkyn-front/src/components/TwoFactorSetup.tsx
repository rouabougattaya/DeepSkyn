              ...
              <div className="bg-white p-6 rounded-lg border border-slate-200 flex flex-col items-center justify-center min-h-[240px]">
                {loading ? (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm text-slate-500">Génération du code...</p>
                  </div>
                ) : qrCode ? (
                  <img
                    src={qrCode}
                    ...
                    onError={() => setError("Erreur d'affichage du QR Code")}
                  />
                ) : (
                  <div className="text-center p-4">
                    <p className="text-slate-500 text-sm mb-4">Le code QR n'a pas pu être chargé.</p>
                    <button
                      type="button"
                      onClick={handleSetup}
              ...
              {secret && !loading && (
                <div className="bg-slate-50 border border-slate-200 p-4 rounded-lg">
                  <p className="text-sm font-medium text-slate-900 mb-2">
                    Code de secours (en cas de perte du téléphone) :
                  </p>
