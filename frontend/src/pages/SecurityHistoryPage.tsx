  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-slate-900">Security History</h1>
            </div>
            <button
              onClick={loadData}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {userScore && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Security Score</h2>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <div className="text-sm text-slate-600">Consistent names</div>
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <div className="text-sm text-slate-600">Unusual locations</div>
