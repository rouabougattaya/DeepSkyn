...
/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Constants ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
const CONDITION_META: Record<string, {
    ...
    'black_dots': {
        ...
        description: 'Formation de microcom├®dons'
    },
};

const BLEND_LABELS: Record<string, { label: string; helper: string }> = {
    'Acne': { label: 'Acn├®', helper: 'Fusion photo + questionnaire' },
    'Blackheads': { label: 'Points noirs', helper: 'Visuel + auto-├®valuation' },
    'Enlarged-Pores': { label: 'Pores', helper: 'Mix AI + ressenti' },
    'Skin Redness': { label: 'Rougeurs', helper: 'Observation + v├®cu' },
};
...
/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Helper Components ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                        ...
                        <div style={{ color: '#64748b', fontSize: 11 }}>
                            {condition.count} d├®tection{condition.count > 1 ? 's' : ''} ┬À s├®v├®rit├® {(condition.severity * 100).toFixed(0)}%
                        </div>
                    </div>
                </div>
                <div style={{
...
/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Main Page ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
export default function SkinAnalysisPage() {
    ...
    const speakAnalysis = useCallback(() => {
        ...
        const text = `
            ...
            Le point critique identifi├® est ${CONDITION_META[result.analysis.worstCondition]?.label || result.analysis.worstCondition}. 
            Prenez soin de vous avec une routine adapt├®e.
        `;
    ...
    return (
        ...
        /* ÔöÇÔöÇÔöÇÔöÇ PRINT STYLES ÔöÇÔöÇÔöÇÔöÇ */
        @media print {
          @page {
            margin: 15mm;
            size: A4;
      ...
      `}</style>
            ...
            <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    {result && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 8 }}>
                            ...
                            <span style={{ fontSize: 13, color: '#10b981', fontWeight: 600, backgroundColor: '#f0fdf4', padding: '4px 12px', borderRadius: '30px' }}>
                                Analyses effectu├®es : {analysisCount}
                            </span>
                        </div>
                    )}
                </div>

                {/* ÔöÇÔöÇ Page Title ÔöÇÔöÇ */}
                <div style={{ marginBottom: 36, textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#64748b', fontSize: 15, maxWidth: 480, margin: '0 auto' }}>
                        7 conditions analys├®es ┬À Score composite intelligent ┬À Expertise Dermatologique
                    </p>
                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        {!result ? (
                            <div className="glass-card" style={{
                                ...
                                <div>
                                    ...
                                    <p style={{ color: '#64748b', fontSize: 14, lineHeight: 1.6 }}>
                                        Lancez l'analyse r├®elle pour obtenir<br />votre score de sant├® cutan├®e.
                                    </p>
                                </div>
                                ...
                                <div style={{
                                    ...
                                    {['Mod├¿le IA Vision', 'Adapteur de d├®tection', 'Agr├®gation des m├®triques', 'Calcul expert (7 conditions)'].map((step, i) => (
                            ...
                            <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                ...
                                <div className="glass-card" style={{
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div style={{
                                                ...
                                                <span style={{ fontSize: 11, color: '#94a3b8' }}>
                                                    {result.totalDetections} d├®tections analys├®es
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{
                                        ...
                                        >
                                            ...
                                            {isSpeaking ? 'Arr├¬ter l\'├®coute' : '├ëcouter l\'analyse'}
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                                                ...
                                                {result.metaWeighting && (
                                                    <div style={{ fontSize: 11, color: '#0ea5e9', fontWeight: 700 }}>
                                                        {Math.round((result.metaWeighting.aiWeight ?? 0) * 100)}% IA ┬À {Math.round((result.metaWeighting.userWeight ?? 0) * 100)}% Vous
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            {!hasPhoto && (
                                                <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 8 }}>
                                                    Aucun selfie fourni ┬À Fusion bas├®e sur le questionnaire et l'estimation profil IA.
                                                </div>
                                            )}
                                        </div>
                                    )}
                                ...
                                <div className="glass-card" style={{ padding: 24 }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                        {result.conditionScores.map(condition => {
                                            const meta = CONDITION_META[condition.type];
                                            if (!meta) return null;
                                            const severity = condition.score < 50 ? 'S├®v├¿re' : condition.score < 75 ? 'Mod├®r├®' : 'Contr├┤l├®';
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{ fontSize: 11, color: '#64748b', lineHeight: 1.6 }}>
                                            Score 0ÔÇô100 : plus le score est <strong style={{ color: '#10b981' }}>├®lev├®</strong>, meilleure est la condition.
                                            L'IA analyse vos pr├®occupations pour pond├®rer le score global.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#0d9488] p-8 rounded-3xl shadow-xl shadow-teal-500/20 text-white relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-lg font-medium leading-relaxed italic">
                                            "Votre peau montre des signes de vitalit├®. Maintenez votre routine actuelle pour pr├®server ces r├®sultats."
                                        </p>
                                    </div>
                                </div>
                                            ...
                                            {result.recommendations.map((product, idx) => (
                                                <div key={idx} style={{
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 }}>
                                                        <span style={{ fontWeight: 800, color: '#0f172a' }}>┬ú{product.price.toFixed(2)}</span>
                                ...
                                {/* ­ƒæç BOUTON VERS TA PAGE PRODUITS ­ƒæç */}
                                <div className="mt-4 text-center">
                                    ...
                                    >
                                        ­ƒøì´©Å Parcourir tous les produits
                                    </Link>
                                    <p className="text-xs text-slate-500 mt-2">
                                        Filtrez par prix, ingr├®dients, type de peau et plus
                                    </p>
                                </div>
            ...
            {/* ÔöÇÔöÇÔöÇÔöÇ PRINTABLE REPORT TEMPLATE ÔöÇÔöÇÔöÇÔöÇ */}
            {result && (
                <div id="printable-report" style={{ background: 'white', padding: '10mm' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: 24, borderRadius: 16, border: '1px solid #e2e8f0', textAlign: 'center' }}>
                            ...
                            <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: 15, display: 'flex', flexDirection: 'column', gap: 8 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12 }}>
                                    <span style={{ color: '#64748b' }}>├ége:</span>
                        ...
                        <div>
                            ...
                            <div style={{ marginBottom: 20 }}>
                                <p style={{ fontSize: 14, color: '#334155', lineHeight: 1.6, marginBottom: 15 }}>
                                    L'analyse multi-dimensionnelle r├®v├¿le un aspect optimal concernant la condition <strong>{CONDITION_META[result.analysis.bestCondition]?.label || result.analysis.bestCondition}</strong>. 
                                    Cependant, une attention particuli├¿re est recommand├®e pour <strong>{CONDITION_META[result.analysis.worstCondition]?.label || result.analysis.worstCondition}</strong> qui pr├®sente le score le plus bas de la s├®rie.
                                </p>
                            </div>
                    ...
                    <div style={{ marginBottom: 40 }}>
                        <h2 style={{ fontSize: 16, fontWeight: 800, color: '#0f172a', marginBottom: 15, borderLeft: '4px solid #0d9488', paddingLeft: 12 }}>Analyse des Conditions Cutatn├®es</h2>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead>
                                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                                    ...
                                    <th style={{ textAlign: 'center', padding: '12px 8px', fontSize: 12, color: '#64748b' }}>S├ëV├ëRIT├ë</th>
                                    <th style={{ textAlign: 'left', padding: '12px 8px', fontSize: 12, color: '#64748b' }}>INTERPR├ëTATION</th>
                                </tr>
                            </thead>
                            <tbody>
                                {result.conditionScores.map(c => {
                                    ...
                                    const status = c.score >= 75 ? 'Contr├┤l├®' : c.score >= 50 ? 'Mod├®r├®' : 'S├®v├¿re';
                                    return (
                    ...
                    {result.recommendations && result.recommendations.length > 0 && (
                        <div style={{ marginBottom: 40, breakInside: 'avoid' }}>
                            <h2 style={{ fontSize: 16, fontWeight: 800, color: '#0f172a', marginBottom: 15, borderLeft: '4px solid #0d9488', paddingLeft: 12 }}>Routine Recommand├®e</h2>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 15 }}>
                                {result.recommendations.slice(0, 3).map((p, idx) => (
                                    <div key={idx} style={{ padding: 16, borderRadius: 12, border: '1px solid #e2e8f0', background: 'white' }}>
                                        ...
                                        <div style={{ fontSize: 12, fontWeight: 700, color: '#0f172a' }}>┬ú{p.price.toFixed(2)}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div style={{ marginTop: 'auto', paddingTop: 20, borderTop: '1px solid #eee', textAlign: 'center' }}>
                        <p style={{ fontSize: 10, color: '#94a3b8', margin: 0 }}>
                            Ce rapport a ├®t├® g├®n├®r├® par l'Intelligence Artificielle de DeepSkyn. 
                            Cette analyse n'est pas un diagnostic m├®dical et ne remplace pas l'avis d'un dermatologue professionnel.
                        </p>
