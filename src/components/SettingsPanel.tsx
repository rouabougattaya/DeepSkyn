      ...
      <div className="bg-white border border-slate-200 rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className={`px-3 py-1 rounded-full text-sm font-medium ${
            twoFAEnabled ? 'bg-green-100 text-green-800' : 'bg-slate-100 text-slate-700'
          }`}>
        ...
        <p className="text-slate-600 mb-4">
          Sécurisez votre compte en activant l'authentification à deux facteurs avec une application Authenticator.
        </p>
              ...
              <form onSubmit={handleDisableTwoFA} className="space-y-3">
                <div>
                  <label className="text-slate-700 text-sm block mb-2">
                    Veuillez entrer votre mot de passe pour désactiver le 2FA
                  </label>
                  <input
                    type="password"
